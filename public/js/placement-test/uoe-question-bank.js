...
var questions = [
  {
    text: "<b>Lucy: </b>*What* is your name? <br><b>Mark:</b>My name's Mark.",
    id: 1,
    answer: ["What"],
    level: 1,
  },
  ...
  {
    text: "<b>Bob:</b>When *is* your birthday?<br><b>Ashley:</b>It's on April 4th.",
    id: 3,
    answer: ["is"],
    level: 1,
  },
  {
    text: "<b>John: </b>*How* old are you? <br><b>Linda: </b>I'm 20 years old",
    id: 4,
    answer: ["How"],
    level: 1,
  },
  {
    text: "<b>Paul: </b>What *do* you do for a living?<br><b>Steve: </b> I'm *a* lawyer. ",
    id: 5,
    answer: ["do", "a"],
    level: 2,
  },
  {
    text: "<b>Graig: </b>*Where* are you from?<br><b>Maria: </b>I'm *from* Colombia.<br><b>Graig: </b>Really? I thought you were from Mexico.",
    id: 6,
    answer: ["Where", "from"],
    level: 2,
  },
  {
    text: "<b>Karen: </b>Where *does* he live now?<br> <b>Thomas: </b>He lives *in* Barcelona.",
    id: 7,
    answer: ["does", "in"],
    level: 2,
  },
  {
    text: "<b>Peter: </b> Now tell me about your sister. How many children does *she* have?<br><b>Jude: </b> She *has* two sons and a daughter",
    id: 8,
    answer: ["she", "has"],
    level: 2,
  },
  ...
  {
    text: "<b>Barbara: </b>What *was* your favorite TV program when you were a kid?",
    id: 13,
    answer: ["was"],
    level: 4,
  },
  {
    text: "<b>Jessica: </b>*Did* you go shopping yesterday?<br><b>Andrew: </b>No, I didn't. but I'll go shopping tonight.",
    id: 14,
    answer: ["did"],
    level: 4,
  },
  ...
  {
    text: "My name's Joe, and I want *to* tell you a little *about* myself. I live in a small town called Greenfield. I'm *a* high school student and I love learning new things. In *my* free time, I enjoy reading books and watching movies. I also like going for walks in the park and playing soccer *with* my friends. I have a pet dog named Max, and he's my best friend. He can't live without me, and I can't live without him either. I think pets make life more interesting. What about you? Do you think pets make life more enjoyable?",
    id: 21,
    answer: ["to", "about", "a", "my", "with"],
    level: 6,
  },
  {
    text: "Hi everyone! I'm Mark and I am *an* engineer. I work for a company named 'Future Tech'. I began working there 3 years *ago*, and I really like my job. I love it because I learn about new technologies and I like my co-workers. They *are* awesome! I live in the city and I like its vibrant energy. In my spare time, I like *to* read books, especially those related to science and technology. I also love to play chess *with* my friends and go for jogs in the morning. I believe staying healthy is as important as working hard.",
    id: 22,
    answer: ["an", "ago", "are", "to", "with"],
    level: 6,
  },
  {
    text: "Hi, I'm Billy, and I'd like *to* talk a little *about* myself. I work as *a* gardener in a large park in the city. I love my job because I always enjoy being around nature. I live in a small house near the park. Last year, I adopted a cat from the local animal shelter. She's called Misty and she's now my best friend. We spend a lot *of* time together, especially when I get home from work. Sometimes we sit in the garden and watch the birds until it gets dark. *On* Saturdays, we always watch movies until midnight. Misty loves being on the sofa, and I love watching comedy movies with her",
    id: 23,
    answer: ["to", "about", "a", "of", "on"],
    level: 6,
  },
  {
  ...
  {
    text: "<b>Interviewer: </b>*Is* there anything you'd like to ask?<br><b>Interviewee: </b>Yes, how *much* is the pay for this job?<br><b>Interviewer: </b>This position pays $4,000 a month.",
    id: 28,
    answer: ["is", "much"],
    level: 8,
  },
  {
    text: "<b>Mark: </b>How *many* people *are* there at the party now?<br><b>Paul: </b>Around nine or ten",
    id: 29,
    answer: ["many", "are"],
    level: 8,
  },
  {
    text: "<b>Graig: </b>Hey Sarah, what's a 'selfie'?<b><br>Sarah: </b>A selfie is just a picture of *yourself|oneself*. It's when you hold the camera with your hands and take a photo of *your|one's* own face.",
    id: 30,
    answer: ["yourself", "your"],
    level: 8,
    url: "https://d37w1mprrue3dh.cloudfront.net/Pics/A2/selfie.jpg",
  },
  {
    text: "<b>Charles: </b>Hey Nancy, why are you buying all that food?<b><br>Nancy: </b>There *will* *be* a party in my house tomorrow. You should come.<br><b>Charles: </b>Sure, I will. Thank you.",
    id: 31,
    answer: ["will", "be"],
    level: 9,
  },
  {
    text: "<b>Detective: </b>What *were* you doing yesterday at 2:00 p.m.?</br><b>Suspect: </b>I *was* taking a nap.",
    id: 32,
    answer: ["were", "was"],
    level: 9,
  },
  {
    text: "<b>Mom: </b>What *was* your brother doing when I called this morning?</br><b>Son: </b>He was right next to me. We *were* playing video games together when you called.",
    id: 33,
    answer: ["was", "were"],
    level: 9,
    url: "https://d37w1mprrue3dh.cloudfront.net/Pics/A2/boys-gaming.jpg",
  },
  {
    text: "<b>Dad: </b>What *are* you doing with all those paint cans?</br><b>Emma: </b>I *am* redecorating my room. I wanna try some new colors.",
    id: 34,
    answer: ["are", "am"],
    level: 9,
    url: "https://d37w1mprrue3dh.cloudfront.net/Pics/A2/redecorating.jpg",
  },
  {
    text: "<b>Carol: </b>Look. *It* *is* raining pretty heavily. You'll need an umbreall if you don't want to get soaked to the bone.</br><b>Wendy: </b>You're right.",
    id: 35,
    answer: ["it", "is"],
    level: 9,
    url: "https://d37w1mprrue3dh.cloudfront.net/Pics/A2/raining.jpg",
  },
  {
  ...
  {
    text: "When I first started learning guitar, I found it very difficult. Especially because it was my first musical instrument and I *had* never studied music before. *At* first, the strings hurt my fingers so bad, but as time went by, I got used to the feeling of the strings and then fell in love *with* the instrument. It's *been* almost three years since I first started my guitar lessons, and I think it's the best decision I've *made* in my life. I think playing the guitar is really my thing!",
    id: 58,
  ...
  {
    text: "I wish I ___ a better job. I don't enjoy this kind of work",
    id: 71,
    answer: ["had"],
    level: 20,
  ...
  {
    text: "The new employee was able to _____ quickly with her colleagues and created a positive work environment.",
    id: 75,
    answer: ["get along"],
    level: 21,
